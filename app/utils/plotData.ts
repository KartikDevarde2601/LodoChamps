...
export const plot2Data :Array<number> =[
    24,25,26,23,332,27,22,332,28,21,333,29,20,334,30,19,335,31
]
...
export const ArrowSpots :Array<number> =[
    12,51,38,25
]

export const StartSpots :Array<number> =[
    9,22,35,48
]

export const turningPoint :Array<number> =[
    12,51,38,25
]
export const VistorySpot :Array<number> =[
    111,221,331,441
]